...
function createHeader() {
 ...
 <figure>
  ...
  <figcaption><strong>Iraqi</strong> made, <strong>Texas</strong> inspired</figcaption>
 </figure>
 <div class="flex">
  <a href="https://www.doordash.com/store/lil-baghdad-copperas-cove-23416610/?pickup=true&utm_campaign=gpa" target="_blank" aria-label="Order on Doordash">
  ...
  <a href="https://www.ubereats.com/store/lil-baghdad/ugkEkaVyX0eNfA6ezGU0eA" target="_blank" aria-label="Order on UberEats">
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1052 170" width="146" height="24">
 ...
 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960" height="24" width="24" fill="currentColor">
  <path d="M480 591q-6 0-11-2t-10-7L261 384q-9-9-9-21t9-21q9-9 21-9t21 9l177 177 177-177q9-9 21-9t21 9q9 9 9 21t-9 21L501 582q-5 5-10 7t-11 2Zm0 253q-6 0-11-2t-10-7L261 637q-9-9-9-21t9-21q9-9 21-9t21 9l177 177 177-177q9-9 21-9t21 9q9 9 9 21t-9 21L501 835q-5 5-10 7t-11 2Z"/>
 </svg>
...
function createFooter () {
 ...
 <a href="/" aria-label="Lil Baghdad home">
  <img src="images/logo.png" alt="Lil Baghdad" width="140px" height="140px">
 </a>
 <ul>
  <li>
   <a href="https://www.facebook.com/profile.php?id=100074970285412/" target="_blank" aria-label="Lil Baghdad on Facebook">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20" fill="#e1e3e5">
  ...
  <li>
   <a href="https://www.instagram.com/desireddishes/" target="_blank" aria-label="Lil Baghdad on Instagram">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="20" height="20" fill="#e1e3e5">
  ...
  <li>
   <a href="https://goo.gl/maps/DjnmrwDQn6bWSLAj9" target="_blank" aria-label="Lil Baghdad on Google Maps">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512" width="20" height="20" fill="#e1e3e5">
